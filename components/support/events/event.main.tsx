  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      setEvents([
        ...
        // You can remove this item to test the "no event" state
      ]);
      setLoading(false);
    }, 2000);
      ...
      <div className="bg-white shadow rounded-xl p-6">
        <div className="flex items-center justify-between pb-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">
            {loading ? <Skeleton width={120} /> : "All Events"}
          </h2>
        </div>
              ...
              {events.map((event) => (
                ...
                >
                  <div className="relative">
                    <span
                      className={`absolute top-2 left-2 z-10 text-xs font-semibold px-3 py-1 rounded-md text-white ${
